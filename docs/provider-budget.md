...
|---|---:|---:|---:|---|
| A. Seven-provider streaming spine | **$11/mo** | **$5 + Soniox's undisclosed top-up floor** | **$100-$150** | Deepgram, ElevenLabs, OpenAI, Soniox, Cartesia, Hume and Rime. ElevenLabs Starter ($6) + Cartesia Pro ($5) are the published subscriptions. Hume's public page exposes usage pricing but did not yield a verifiable self-serve plan floor. |
...
| Hume | Metered access / plan | Undisclosed | The official page publishes $0.04/minute additional EVI usage, but did not expose a verifiable self-serve plan floor in this research pass. | [Hume pricing](https://www.hume.ai/pricing) |
