...
KNOWN_STT = {
    ...
    "xai-grok-stt": "Speko-listed (Grok STT) - xAI API is prepaid-credit billing only, no free tier - excluded by the $0/no-card rule",
    "inworld-stt": "Speko-listed (Realtime STT-1) - signup captcha-blocked (reCAPTCHA never validates from the cloud browser; retried twice 2026-09-14)",
    "alibaba-qwen3-asr": "Speko-listed (Qwen3-ASR) - 90-day free quota on Model Studio Singapore; signup queued",
    "modulate-velma": "Speko-listed (Velma 2) - signup queued",
    "soniox": "Speko-listed (stt-rt-v5) - signup in progress (password-reset mail from console.soniox.com undelivered as of 2026-09-14)",
    "gradium": "Speko-listed (Gradium ASR) - signup queued",
    ...
    "nari-qwen3-asr-fast": "Speko-listed (Qwen3-ASR Fast) - Nari free public beta; signup queued",
    "meta-muse": "Speko-listed (Muse Voice Transcribe) - available on Meta Model API (dev.meta.ai); free-tier terms unverified, signup queued",
...
KNOWN_TTS = {
    ...
    "soniox-tts": "Speko-listed (tts-rt-v1, tts-rt-v2) - same account as the STT signup in progress",
    "gemini-tts": "Speko-listed (gemini-3.1-flash-tts-preview) - Google AI Studio key is free without a card; queued",
    "inworld-tts": "Speko-listed (inworld-tts-2, inworld-tts-2-flash) - same captcha-blocked signup as STT",
    "xai-grok-tts": "Speko-listed (grok-tts) - xAI API is prepaid-credit billing only, no free tier - excluded by the $0/no-card rule",
    "speechify": "Speko-listed (simba-3.2) - signup queued",
    "fish-audio": "Speko-listed (s2.1-pro) - signup queued",
    "minimax": "Speko-listed (speech-2.8-hd, speech-2.6-hd/turbo) - signup queued",
    "gradium-tts": "Speko-listed (Gradium TTS) - signup queued",
    "alibaba-qwen3-tts": "Speko-listed (qwen3-tts-flash) - same queued Alibaba signup as STT",
    "nari-qwen3-tts-fast": "Speko-listed (Qwen3-TTS Fast) - Nari free public beta; signup queued",
    "palabra": "Speko-listed (palabra-tts-v1) - signup queued",
    "bland": "Speko-listed (bland-speech) - signup queued",
    "maya": "Speko-listed (Maya 2) - signup queued",
    "azure-speech": "Azure signup requires a credit card - excluded by the $0/no-card rule",
