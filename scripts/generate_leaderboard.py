...
KNOWN_STT = {
    ...
    "soniox": "Speko-listed (stt-rt-v5) - signup works without a card, but the account gets no free credits: API returns 402 'Organization balance exhausted' (verified 2026-09-14)",
